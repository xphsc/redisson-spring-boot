 ...
 * @since 1.0.0
 */
public class LockPointcutAdvisor extends AbstractPointcutAdvisor implements ApplicationContextAware {
    ...
    public Pointcut getPointcut() {
        if (this.pointcut == null) {
            this.pointcut = buildPointcut(RedissonLock.class);
        }
    ...
    private Advice buildAdvice() {
        LockMethodInterceptor interceptor = new LockMethodInterceptor(applicationContext);
        return interceptor;
    }
